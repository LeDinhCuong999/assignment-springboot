package aptech.t2010a.assignmentspringboot.config;

import com.auth0.jwt.interfaces.DecodedJWT;
import com.google.gson.Gson;
import aptech.t2010a.assignmentspringboot.util.JwtUtil;
...
public class ApiAuthorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        // nếu người client gọi dến link đăng nhập, đăng ký và những link k cần check login
        ...
        // lấy thông tin token từ trong requets header
        try {
            // remove chữ Bearer
